    ...
    <li>
      <article class="accordion">
        ...
        <ul class="content closed">
          ...
          <li>Abasto total y permanente de agua potable para todo el municipio: Perforación de 5 pozos de agua.
          Rehabilitación del drenaje del municipio.</li>
        </ul>
      </article>
    </li>
    <li>
      <article class="accordion">
        ...
        <ul class="content closed">
          ...
          <li>Implementación de cámaras con botones de pánico en las principales avenidas del municipio y áreas dónde se tiene registrado el mayor índice de incidencia delictiva.</li>
          <li>Promover la cultura de la legalidad y la prevención integral del delito entre la ciudadanía.</li>
          <li>Articulación de campañas de divulgación para niñas, niños y jóvenes sobre sus derechos.</li>
        </ul>
      </article>
    </li>
    <li>
      <article class="accordion">
        ...
        <ul class="content closed">
          ...
          <li>Impulsar premios y concursos que fomenten la creatividad, responsabilidad social y vocación emprendedora de los jóvenes.</li>
          <li>Impulsar y Detonar el crecimiento de la zona industrial de Valle de Chalco Solidaridad para generar más empleos.</li>
        </ul>
      </article>
    </li>
    <li>
    ...
    <li>
      <article class="accordion">
        ...
        <ul class="content closed">
          ...
          <li>Recuperación de todos los espacios deportivos del municipio.</li>
          <li>Cobertura total de internet en espacios públicos.</li>
          <li>Dignificación de todos los mercados públicos.</li>
          <li>Construcción de la Casa de la Cultura de Valle de Chalco Solidaridad.</li>
          <li>Remodelación de la Ex Hacienda de Xico para incentivar el turismo y hacerla motivo de orgullo para los vallechaquenses.</li>
        </ul>
      </article>
    </li>
    <li>
      <article class="accordion">
        ...
        <ul class="content closed">
          ...
          <li>Construcción de un Hospital Pediátrico.</li>
          <li>Construcción del Centro de Rehabilitación para personas con discapacidad.</li>
          <li>Rehabilitación del panteón municipal.</li>
          <li>Reapertura del antirrábico del municipio.</li>
          <li>Campañas continúas de esterilización.</li>
        </ul>
      </article>
    </li>
    <li>
      <article class="accordion">
        ...
        <ul class="content closed">
          ...
          <li>Microcréditos para incentivar la apertura de nuevos negocios.</li>
        </ul>
      </article>
    </li>
  </ol>
